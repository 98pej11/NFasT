...
let ssafyTokenContract, salesFactoryContract, nfastContract, salesContract,salesContract2;
let itemId = 0;
let price = 20;
...
contract("Sale Contract Testing", (accounts) => {
    ...
    it("1_create sale", async () => {
        await nfast.create(seller, uri,seller,getTime(),false,getTime(),getTime(),20,10);
        ...
        salesContract = (await factory.createSale(1, price, getTime(),getTime()+1000000)).logs[0].address;
...
//        console.log(await factory.allSales())
    ...
    it("3_refund", async () => {
        salesContract2 = (await factory.createSale(1, price+10, getTime(),getTime()+1000000,{from: buyer})).logs[0].address;
